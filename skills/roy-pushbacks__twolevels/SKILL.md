---
name: roy-pushbacks__twolevels
description: Use when you want to understand something at two depths in one response. Explains any concept simply first, then with full technical depth. Use when learning something new or when explaining to two different audiences.
---
