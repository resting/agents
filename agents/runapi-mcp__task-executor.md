---
name: runapi-mcp__task-executor
description: Media task execution agent. Delegates here for create_task calls so the main conversation stays focused. Spawn one per task for parallel generation.
